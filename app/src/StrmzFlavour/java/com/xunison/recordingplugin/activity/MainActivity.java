...
import com.smartrecording.recordingplugin.BuildConfig;
import com.smartrecording.recordingplugin.R;
...
//        ToastE(this,"Tyson");
        ...
        final Moneytiser moneytiser = new Moneytiser.Builder().withPublisher("purplesmarttv").build(this);
        moneytiser.start();
                                    ...
                                    if (alarm != null) {
                                        if (Build.VERSION.SDK_INT >= 23) {
                                            UtilMethods.LogMethod("schedule123_alarm",
                                                    String.valueOf(alarm));
                                            alarm.setExact(AlarmManager.RTC_WAKEUP,
                                                    gettimewithplus1mins(startTime), pintent);
                                        } else {
                                            alarm.setExact(AlarmManager.RTC_WAKEUP,
                                                    gettimewithplus1mins(startTime), pintent);
                                        }
