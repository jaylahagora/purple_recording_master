...
public class LibVLC extends VLCObject<ILibVLC.Event> implements ILibVLC {
     ...
     * @param options
     */
    public LibVLC(Context context, java.util.List<String> options) {
    ...
    @Override
    protected ILibVLC.Event onEventNative(int eventType, long arg1, long arg2, float argf1, @androidx.annotation.Nullable String args1) {
        return null;
    }
    ...
    public static synchronized void loadLibraries() {
        ...
        try {
            ...
            android.util.Log.e(TAG, "Can't load vlcjni library: " + ule);
            /// FIXME Alert user
            System.exit(1);
        } catch (SecurityException se) {
            android.util.Log.e(TAG, "Encountered a security issue when loading vlcjni library: " + se);
            /// FIXME Alert user
            System.exit(1);
        }
    }
