...
//        public static final int ChapterChanged      = 0x11d;
        ...
        protected Event(int type, long arg1, @androidx.annotation.Nullable String args1) {
    ...
    private AudioDeviceCallback createAudioDeviceCallback() {
        ...
        return new AudioDeviceCallback() {
            ...
            private android.util.SparseArray<Long> mEncodedDevices = new android.util.SparseArray<>();
     ...
     * @param ILibVLC a valid libVLC
     */
    public MediaPlayer(ILibVLC ILibVLC, VLCPlayer vlcPlayer) {
        super(ILibVLC);
     ...
     */
    public MediaPlayer(@androidx.annotation.NonNull IMedia media) {
        super(media);
     ...
     */
    public void attachViews(@androidx.annotation.NonNull VLCPlayer surfaceFrame, @androidx.annotation.Nullable DisplayManager dm, boolean subtitles, boolean textureView) {
     ...
     */
    public void setVideoScale(@androidx.annotation.NonNull ScaleType type) {
        if (vlcPlayer != null) vlcPlayer.setVideoScale(type);
    }
    ...
    public ScaleType getVideoScale() {
        return vlcPlayer != null ? vlcPlayer.getVideoScale() : ScaleType.SURFACE_BEST_FIT;
    }
     ...
     * @param media a valid Media object
     */
    public void setMedia(@androidx.annotation.Nullable IMedia media) {
        if (media != null) {
            if (media.isReleased())
     ...
     */
    public int setRenderer(@androidx.annotation.Nullable RendererItem item) {
     ...
     * @throws IOException
     */
    public void playAsset(@androidx.annotation.NonNull Context context, @androidx.annotation.NonNull String assetFilename) throws IOException {
     ...
     */
    public void play(@androidx.annotation.NonNull AssetFileDescriptor afd) {
     ...
     */
    public void play(@androidx.annotation.NonNull String path) {
     ...
     */
    public void play(@androidx.annotation.NonNull Uri uri) {
     ...
     */
    public void play(@androidx.annotation.NonNull IMedia media) {
        setMedia(media);
        media.release();
        play();
    }
    ...
    @Override
    protected synchronized Event onEventNative(int eventType, long arg1, long arg2, float argf1, @androidx.annotation.Nullable String args1) {
        switch (eventType) {
