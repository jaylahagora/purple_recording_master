...
public class RendererDiscoverer extends VLCObject<RendererDiscoverer.Event> {
    ...
    final java.util.List<RendererItem> mRenderers = new ArrayList<>();
    ...
    @Override
    protected Event onEventNative(int eventType, long arg1, long arg2, float argf1, @androidx.annotation.Nullable String args1) {
        switch (eventType) {
