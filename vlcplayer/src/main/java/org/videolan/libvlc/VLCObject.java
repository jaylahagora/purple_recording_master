...
abstract class VLCObject<T extends AbstractVLCEvent> implements IVLCObject<T> {
    ...
    private synchronized void dispatchEventFromNative(int eventType, long arg1, long arg2, float argf1, @androidx.annotation.Nullable String args1) {
        if (isReleased())
            return;
    ...
    private static void dispatchEventFromWeakNative(Object weak, int eventType, long arg1, long arg2,
                                                    float argf1, @androidx.annotation.Nullable String args1) {
