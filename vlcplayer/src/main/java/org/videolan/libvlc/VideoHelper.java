...
class VideoHelper implements IVLCVout.OnNewVideoLayoutListener {
    ...
    VideoHelper(MediaPlayer player, VLCPlayer surfaceFrame, DisplayManager dm, boolean subtitles, boolean textureView) {
        init(player, surfaceFrame, dm, subtitles, !textureView);
    }

    private void init(MediaPlayer player, VLCPlayer surfaceFrame, DisplayManager dm, boolean subtitles, boolean useSurfaceView) {
        mMediaPlayer = player;
        mDisplayManager = dm;
    ...
    void attachViews() {
        ...
        if (mOnLayoutChangeListener == null) {
            mOnLayoutChangeListener = new android.view.View.OnLayoutChangeListener() {
    ...
    void updateVideoSurfaces() {
        ...
        android.view.View videoView = mVideoSurface;
        if (videoView == null)
